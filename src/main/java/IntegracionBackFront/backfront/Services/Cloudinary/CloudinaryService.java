...
public class CloudinaryService {
    ...
    //Contructor para inyeccion de dependencias de Cloudinary
    ...
    private void validateImage(MultipartFile file) {
        ...
        // 2.Verificar si eltamaño excede el limite permitido
        ...
        if (!file.getContentType().startsWith("image/")){
            throw new IllegalArgumentException("El archivo dese ser una imagen valida")
        }
